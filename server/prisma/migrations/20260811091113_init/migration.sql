...
CREATE TABLE "ProgramDay" (
    ...
    "rowBase" REAL NOT NULL DEFAULT 10,
    "rowPct" REAL NOT NULL DEFAULT 10,
    "rowWeek" INTEGER NOT NULL DEFAULT 0,
    "poolShift" INTEGER NOT NULL DEFAULT 0,
    CONSTRAINT "ProgramDay_clientId_fkey" FOREIGN KEY ("clientId") REFERENCES "Client" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "ProgramItem" (
    ...
    "doelgewicht" REAL NOT NULL DEFAULT 0,
    "restSec" INTEGER NOT NULL DEFAULT 90,
    "videoUrl" TEXT,
    "notitie" TEXT,
    "bron" TEXT NOT NULL DEFAULT 'eigen',
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "ProgramItem_dayId_fkey" FOREIGN KEY ("dayId") REFERENCES "ProgramDay" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "Session" (
    ...
    "gestartOp" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "afgerondOp" DATETIME,
    "rpe" INTEGER,
    "opmerking" TEXT,
    ...
    CONSTRAINT "Session_dayId_fkey" FOREIGN KEY ("dayId") REFERENCES "ProgramDay" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "SetLog" (
    ...
    CONSTRAINT "SetLog_programItemId_fkey" FOREIGN KEY ("programItemId") REFERENCES "ProgramItem" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
